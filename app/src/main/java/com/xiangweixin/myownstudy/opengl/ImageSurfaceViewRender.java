...
public class ImageSurfaceViewRender implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        drawWithProgram(programID, vertexData, textureData, texID);
    }
    ...
    private void drawWithProgram(int programID, FloatBuffer vertexPos, FloatBuffer fragPos, int texture) {
